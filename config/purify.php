    ...
    */
    ...
    'configs' => [
        ...
        'posts' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'strong,i,p[style|class],br,span[style|class],a[style|class|href],h1,h2,h3,h4,img[width|height|alt|src|style],figure[class],ol,ul,li',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'text-align,font-family,color,aspect-ratio',
            'CSS.AllowedFonts' => 'Arial,Helvetica,sans-serif,Courier New,Courier,monospace,Georgia,serif,Lucida Sans Unicode,Lucida Grande,Tahoma,Geneva,Times New Roman,Times,Trebuchet MS,Verdana',
            'Attr.AllowedClasses' => ['text-tiny', 'text-small', 'text-big', 'text-huge', 'image'],
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
        ],
